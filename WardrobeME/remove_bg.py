...
if __name__ == "__main__":
    ...
    utils.print_progress(0, count_files, prefix='Progress:', suffix='Complete', bar_length=50)
    for i, filename in enumerate(files):
        utils.print_progress(i + 1, count_files, prefix='Progress:', suffix=filename, bar_length=50)
        remove_bg(filename, inPath, outPath, bg_rect_size, fg_rect_size, resize)
        utils.print_progress(i + 1, count_files, prefix='Progress:', suffix="Complete", bar_length=50)